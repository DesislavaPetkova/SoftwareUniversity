...
function countSubstringOccur(argument) {	
	var check = argument[0];
	var string = argument[1].toLowerCase();	
...
countSubstringOccur(['but', 'But you were living in another world trying to get your message through.']);