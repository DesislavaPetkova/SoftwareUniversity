namespace FurnitureManufacturer.Engine.Factories
{
    ...
    public class FurnitureFactory : IFurnitureFactory
    {
        ...
        public ITable CreateTable(string model, string materialType, decimal price, decimal height, decimal length, decimal width)
        {
            ...
            Table table = new Table(model, material, price, height, length, width);
            return table;
        }
        ...
        {
            var material = this.GetMaterialType(materialType);
            Chair chair = new Chair(model, material, price, height, numberOfLegs);
            return chair;
        }
        ...
        {
            var material = this.GetMaterialType(materialType);
            ConvertibleChair convChair = new ConvertibleChair(model, material, price, height, numberOfLegs);
            return convChair;
        }
