...
<table class="table table-striped table-hover ">
    <thead>
    <tr>
        <th><h2><?php echo $this->article[0][1]?></h2></th>
    </tr>
    </thead>
    <tbody>
        <tr class="danger">
            <td><b><?php echo $this->article[0][2] ?></b></td>
        </tr>
    </tbody>
</table>
<button id="show-comments" class="btn btn-success">Show Comments</button>
<a href="/../comments/createComment/<?php echo $this->article[0][0]?>" id="add-comments" class="btn btn-success">Add
    Comments</a>

<script>
    $('#show-comments').on('click', function(ev){
        $.ajax({
            url: '/comments/showComments/<?php echo $this->article[0][0]?>',
            method: 'GET'
